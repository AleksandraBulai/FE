...
// 2. Перекрасить цвет текста в par (параграфе) в красный

//par.style.color = '#D70040'; // или можно с кавычках написать просто название цвета
...
// 6. Создать кнопку и парграф. При клике на кнопку менять цвет заднего фона параграфа.
// Если длина параграфа >= 30 символов, то цвет заднего фона должен быть светло-зеленый.
// Если меньше, то светло- желтый  
...
// сокращение через тернарный оператор:
changeBackBtn.addEventListener('click', () => {
...
// 6. Создать кнопку и параграф. При клике на кнопку менять цвет заднего фона параграфа. Если длина параграфа >= 30 символов, то цвет заднего фона должен быть светло-зеленый. Если меньше, то светло-желтый. При клике на кнопку также меняется размер шрифта на 32px  
  changeBackBtn.addEventListener('click', () => {
    secondPar.style.backgroundColor = secondPar.innerText.length >= 30 ? 'ligthgreen' : 'lightyellow';
