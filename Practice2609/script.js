...
//2. Arrow function (стрелочная функция)
...
//если строчка кода всего одна можно удалить слово return и все скобки
...
console.log(getTotal(2, 5)); // 5 -2 = 3
console.log(getTotal(2, 2)); // 2 * 2 = 4
console.log(getTotal(6, 1)); // 6 + 1 = 7

// 5. Написать функцию, которая принимает строку. Если длина строки больше 5 символов, то возвращается сообщение 'String length is longer than 5'. Если длина строки меньше 5 символов, то возвращается сообщение 'String length is shorter than 5'. Если длина строки равна 5 символам, то возвращается сообщение 'String length is equal 5'
